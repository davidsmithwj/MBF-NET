...
parser.add_argument('--log_name',
                    type=str,
                    default='1_1_0_e6_loss_0_aug_1')
parser.add_argument('--gpu', type=str, default='0')
parser.add_argument('--fold', type=str, default='0')
parser.add_argument('--dataset', type=str, default='isic2018')

parser.add_argument('--arch', type=str, default='MBF')
...
if parse_config.arch == 'MBF':
    if parse_config.trans == 1:
        from Ours.Base_transformer import MBF
        model = MBF(1, parse_config.net_layer, parse_config.point_pred,
                    parse_config.ppl).cuda()
    else:
        from Ours.base import DeepLabV3
        model = DeepLabV3(1, parse_config.net_layer).cuda()

#E:\github_code\BA-Transformer-main\logs\isic2018\_1_1_0_e6_loss_0_aug_1\fold_0\model
...
model_path=r'F:\BA-Transformer-main\logs\isic2018\_1_1_0_e6_loss_0_aug_1\fold_0\model\best.pkl'
# model = load_model(model, dir_path + 'model\\best.pkl')
model = load_model(model,model_path)
# logging
#txt_path = os.path.join(dir_path + 'parameter.txt')
txt_path=r'F:\BA-Transformer-main\logs\isic2018\_1_1_0_e6_loss_0_aug_1\fold_0\parameter.txt'
logging.basicConfig(filename=txt_path,
                    level=logging.INFO,
                    format='[%(asctime)s.%(msecs)03d] %(message)s',
                    datefmt='%H:%M:%S')

#E:\github_code\BA-Transformer-main\logs\isic2018\_1_1_0_e6_loss_0_aug_1\fold_0
#E:\\github_code\\BA-Transformer-main\\logs\\isic2018\\1_1_0_e6_loss_0_aug_1\\fold_0\\parameter.txt
