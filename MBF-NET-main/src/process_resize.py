...
# process_isic2018(dim=(512,512), save_dir='D:\EDGE-Download\ISIC2016\data',image_dir_path=img_path,mask_dir_path= mask_path)
def process_isic2018(
        dim=(352, 352), save_dir='',image_dir_path='',mask_dir_path=''):
    #image_dir_path = '
    ...
    for image_path, mask_path in tqdm(zip(image_path_list, mask_path_list)):
        if image_path[-3:] == 'jpg':
            ...
            print(image_new.shape,mask_new.shape)
...
def process_ph2():
    ...
    for path in path_list:
        ...
        image_save_path = os.path.join(
            r'D:\EDGE-Download\PH2Dataset\PH2\Image',
            path + '.npy')
        label_save_path = os.path.join(
            r'D:\EDGE-Download\PH2Dataset\PH2\Label',
            path + '.npy')
...
if __name__ == '__main__':
    img_path=r""
    mask_path=r""
    process_isic2018(dim=(512,512), save_dir='',image_dir_path=img_path,mask_dir_path= mask_path)
    # process_ph2()
