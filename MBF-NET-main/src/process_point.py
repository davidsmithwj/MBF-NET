...
def point_gen_isic2018(data_dir):
    R = 10
    N = 25
...
def point_gen_isic2016(root_path):
    R = 10
    N = 25
    data_dir = root_path
    #print(data_dir)

    save_dir = data_dir.replace('Label', 'Point-miji')
    os.makedirs(save_dir, exist_ok=True)
...
if __name__ == '__main__':
    ...
    root_path=r"YOUR DATA"
    data_dir=r"YOUR DATA"
    point_gen_isic2016(root_path)
    #point_gen_isic2018(data_dir)